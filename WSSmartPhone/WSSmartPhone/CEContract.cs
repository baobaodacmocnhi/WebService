            ...
            try
            {
                if (checksum == CGlobalVariable.checksum)
                {
                    ...
                    if (CaNhan)
                        ...
                        content.Add(new StringContent("{\"username\":\"" + MST + "\",\"cmnd\":\"" + CCCD + "\",\"email\":\"" + Email + "\",\"mst\":\"" + MST + "\",\"sdt\":\"" + DienThoai + "\",\"signFrame\":[{\"x\":160,\"y\":180,\"w\":80,\"h\":70,\"page\":4}],\"ten\":\"" + HoTen + "\",\"tenToChuc\":\"\",\"userType\":\"BUSINESS\"}"), "customer");
                    if (GanMoi)
                        content.Add(new StringContent("{\"autoRenew\":\"true\",\"contractValue\":\"0\",\"creationNote\":\"Ghi chú hợp đồng\",\"endDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"flowTemplateId\":\"0fff387d-5646-4993-a5dd-6d96e2036537\",\"templateId\":\"64d3625c22ab89b8111134ad\",\"signFlowType\":\"REQUIRE_FLOW\",\"sequence\":1,\"signFlow\":[{\"signType\":\"DRAFT\",\"departmentId\":\"f420f37a-97c7-421d-af1c-4a0a7dfa88d5\",\"userId\":\"c6ee1894-498e-40fb-848f-00e02ad41f06\",\"sequence\":1,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":470,\"y\":220,\"w\":70,\"h\":50,\"page\":4}]},{\"signType\":\"APPROVAL\",\"departmentId\":\"5858ea78-7919-402a-b1bf-5786f82cb7c8\",\"userId\":\"ada7106d-ee2c-43c6-8b40-b2b3b52e6d95\",\"sequence\":2,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":360,\"y\":180,\"w\":145,\"h\":80,\"page\":4}]},{\"signType\":\"STAMP\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"ea911234-c439-47e8-9d86-c123b9a6ddf8\",\"sequence\":3,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":330,\"y\":210,\"w\":120,\"h\":120,\"page\":4}]}],\"signForm\":[\"OTP\",\"OTP_EMAIL\"],\"title\":\"Hợp đồng gắn mới " + SHS + "\",\"validDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"verificationType\":\"NONE\",\"fixedPosition\":true,\"callbackUrl\":\"\"}"), "contract");
                    else
                        content.Add(new StringContent("{\"autoRenew\":\"true\",\"contractValue\":\"0\",\"creationNote\":\"Ghi chú hợp đồng\",\"endDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"flowTemplateId\":\"a7e6494a-f7bc-4306-a3b6-d0842e9c69f3\",\"templateId\":\"64d3625c22ab89b8111134ad\",\"signFlowType\":\"REQUIRE_FLOW\",\"sequence\":1,\"signFlow\":[{\"signType\":\"DRAFT\",\"departmentId\":\"88bedc40-ccb5-4221-9e7f-c9c5aad49d67\",\"userId\":\"3440ba96-3683-49c3-9324-9e2d670d3481\",\"sequence\":1,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":470,\"y\":220,\"w\":70,\"h\":50,\"page\":4}]},{\"signType\":\"APPROVAL\",\"departmentId\":\"5858ea78-7919-402a-b1bf-5786f82cb7c8\",\"userId\":\"ada7106d-ee2c-43c6-8b40-b2b3b52e6d95\",\"sequence\":2,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":360,\"y\":180,\"w\":145,\"h\":80,\"page\":4}]},{\"signType\":\"STAMP\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"ea911234-c439-47e8-9d86-c123b9a6ddf8\",\"sequence\":3,\"limitDate\":1,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":330,\"y\":210,\"w\":120,\"h\":120,\"page\":4}]}],\"signForm\":[\"OTP\",\"OTP_EMAIL\"],\"title\":\"Hợp đồng sang tên " + DanhBo + "\",\"validDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"verificationType\":\"NONE\",\"fixedPosition\":true,\"callbackUrl\":\"\"}"), "contract");
