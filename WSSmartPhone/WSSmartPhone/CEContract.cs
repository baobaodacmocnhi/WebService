    ...
    public class CEContract
    {
        ...
        , string DienThoai, string Fax, string Email, string TaiKhoan, string Bank, string MST, string CoDHN, string DCLapDat, string NgayHieuLuc, bool GanMoi, bool CaNhan, bool KyCaNhan, string MaDon, string SHS, string checksum, out string strResponse)
        {
            ...
            try
            {
                if (checksum == CGlobalVariable.checksum)
                {
                    if (File.Exists(AppDomain.CurrentDomain.BaseDirectory + @"\Images\EContract.pdf"))
                    {
                    ...
                    else
                    {
                        ...
                        {
                            if (KyCaNhan)
                                content.Add(new StringContent("{\"autoRenew\":\"true\",\"contractValue\":\"0\",\"creationNote\":\"Ghi chú hợp đồng\",\"endDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"flowTemplateId\":\"a7e6494a-f7bc-4306-a3b6-d0842e9c69f3\",\"templateId\":\"64d3625c22ab89b8111134ad\",\"signFlowType\":\"REQUIRE_FLOW_STAMP\",\"sequence\":1,\"signFlow\":[{\"signType\":\"DRAFT\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"2c5969af-508c-42a1-8dd0-129dbc9e5d7f\",\"sequence\":1,\"limitDate\":99,\"signForm\":[\"NO_AUTHEN\"]},{\"signType\":\"DRAFT\",\"departmentId\":\"88bedc40-ccb5-4221-9e7f-c9c5aad49d67\",\"userId\":\"3440ba96-3683-49c3-9324-9e2d670d3481\",\"sequence\":2,\"limitDate\":99,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":470,\"y\":220,\"w\":70,\"h\":50,\"page\":4}]},{\"signType\":\"APPROVAL\",\"departmentId\":\"5858ea78-7919-402a-b1bf-5786f82cb7c8\",\"userId\":\"ada7106d-ee2c-43c6-8b40-b2b3b52e6d95\",\"sequence\":3,\"limitDate\":99,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":370,\"y\":180,\"w\":145,\"h\":80,\"page\":4}]},{\"signType\":\"STAMP\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"ea911234-c439-47e8-9d86-c123b9a6ddf8\",\"sequence\":4,\"limitDate\":99,\"signForm\":[\"SMART_CA\"],\"signFrame\":[{\"x\":330,\"y\":210,\"w\":110,\"h\":110,\"page\":4}]}],\"signForm\":[\"OTP\",\"OTP_EMAIL\",\"USB_TOKEN\"],\"title\":\"Hợp đồng sang tên " + DanhBo + " " + DateTime.Now.ToString("dd/MM/yyyy") + "\",\"validDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"verificationType\":\"NONE\",\"fixedPosition\":true,\"callbackUrl\":\"\"}"), "contract");
                            else
