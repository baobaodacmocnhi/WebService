            ...
            , string DienThoai, string Fax, string Email, string TaiKhoan, string Bank, string MST, string CoDHN, string DCLapDat, string NgayHieuLuc, bool GanMoi, bool CaNhan, string MaDon, string SHS, string checksum)
        {
            ...
            try
            {
                if (checksum == CGlobalVariable.checksum)
                {
                    ...
                    if (CaNhan)
                        content.Add(new StringContent("{\"username\":\"" + CCCD + "\",\"cmnd\":\"\",\"email\":\"\",\"mst\":\"\",\"sdt\":\"" + DienThoai + "\",\"signFrame\":[{\"x\":108.74,\"y\":161.55536,\"w\":135.0392,\"h\":172.59536,\"page\":4}],\"ten\":\"" + HoTen + "\",\"tenToChuc\":\"\",\"userType\":\"CONSUMER\"}"), "customer");
                    else
                        content.Add(new StringContent("{\"username\":\"" + MST + "\",\"cmnd\":\"\",\"email\":\"" + Email + "\",\"mst\":\"" + MST + "\",\"sdt\":\"" + DienThoai + "\",\"signFrame\":[{\"x\":108.74,\"y\":161.55536,\"w\":135.0392,\"h\":172.59536,\"page\":4}],\"ten\":\"" + HoTen + "\",\"tenToChuc\":\"\",\"userType\":\"BUSINESS\"}"), "customer");
                    if (GanMoi)
                        content.Add(new StringContent("{\"autoRenew\":\"true\",\"contractValue\":\"0\",\"creationNote\":\"Ghi chú hợp đồng\",\"endDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"flowTemplateId\":\"0fff387d-5646-4993-a5dd-6d96e2036537\",\"templateId\":\"64d3625c22ab89b8111134ad\",\"signFlowType\":\"REQUIRE_FLOW_STAMP\",\"sequence\":1,\"signFlow\":[{\"signType\":\"DRAFT\",\"departmentId\":\"f420f37a-97c7-421d-af1c-4a0a7dfa88d5\",\"userId\":\"c6ee1894-498e-40fb-848f-00e02ad41f06\",\"sequence\":1,\"limitDate\":1,\"signForm\":[\"NO_AUTHEN\",\"OTP\",\"OTP_EMAIL\",\"SMART_CA\"],\"signFrame\":[{\"x\":500.98,\"y\":192.99536,\"w\":527.2792000000001,\"h\":204.03536,\"page\":4}]},{\"signType\":\"APPROVAL\",\"departmentId\":\"5858ea78-7919-402a-b1bf-5786f82cb7c8\",\"userId\":\"ada7106d-ee2c-43c6-8b40-b2b3b52e6d95\",\"sequence\":2,\"limitDate\":1,\"signForm\":[\"SMART_CA\",\"USB_TOKEN\",\"NO_AUTHEN\",\"OTP\"],\"signFrame\":[{\"x\":389.23,\"y\":151.71536,\"w\":415.5292,\"h\":162.75536,\"page\":4},{\"signType\":\"STAMP\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"ea911234-c439-47e8-9d86-c123b9a6ddf8\",\"sequence\":3,\"limitDate\":1,\"signForm\":[\"USB_TOKEN\",\"SMART_CA\",\"OTP\",\"OTP_EMAIL\"],\"signFrame\":[{\"x\":326.23,\"y\":185.55536,\"w\":352.5292,\"h\":196.59536,\"page\":4}]}]}],\"signForm\":[\"OTP\",\"OTP_EMAIL\",\"NO_AUTHEN\"],\"title\":\"Hợp đồng gắn mới " + HoTen + "\",\"validDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"verificationType\":\"NONE\",\"fixedPosition\":true,\"callbackUrl\":\"\"}"), "contract");
                    else
                        content.Add(new StringContent("{\"autoRenew\":\"true\",\"contractValue\":\"0\",\"creationNote\":\"Ghi chú hợp đồng\",\"endDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"flowTemplateId\":\"a7e6494a-f7bc-4306-a3b6-d0842e9c69f3\",\"templateId\":\"64d3625c22ab89b8111134ad\",\"signFlowType\":\"REQUIRE_FLOW_STAMP\",\"sequence\":1,\"signFlow\":[{\"signType\":\"DRAFT\",\"departmentId\":\"88bedc40-ccb5-4221-9e7f-c9c5aad49d67\",\"userId\":\"3440ba96-3683-49c3-9324-9e2d670d3481\",\"sequence\":1,\"limitDate\":1,\"signForm\":[\"NO_AUTHEN\",\"OTP\",\"OTP_EMAIL\",\"SMART_CA\"],\"signFrame\":[{\"x\":500.98,\"y\":192.99536,\"w\":527.2792000000001,\"h\":204.03536,\"page\":4}]},{\"signType\":\"APPROVAL\",\"departmentId\":\"5858ea78-7919-402a-b1bf-5786f82cb7c8\",\"userId\":\"ada7106d-ee2c-43c6-8b40-b2b3b52e6d95\",\"sequence\":2,\"limitDate\":1,\"signForm\":[\"SMART_CA\",\"USB_TOKEN\",\"NO_AUTHEN\",\"OTP\"],\"signFrame\":[{\"x\":389.23,\"y\":151.71536,\"w\":415.5292,\"h\":162.75536,\"page\":4},{\"signType\":\"STAMP\",\"departmentId\":\"079c68fb-1002-4b13-93bc-92d97c290096\",\"userId\":\"ea911234-c439-47e8-9d86-c123b9a6ddf8\",\"sequence\":3,\"limitDate\":1,\"signForm\":[\"USB_TOKEN\",\"SMART_CA\",\"OTP\",\"OTP_EMAIL\"],\"signFrame\":[{\"x\":326.23,\"y\":185.55536,\"w\":352.5292,\"h\":196.59536,\"page\":4}]}]}],\"signForm\":[\"OTP\",\"OTP_EMAIL\",\"NO_AUTHEN\"],\"title\":\"Hợp đồng sang tên " + HoTen + "\",\"validDate\":\"" + DateTime.Now.ToString("yyyy-MM-dd") + "\",\"verificationType\":\"NONE\",\"fixedPosition\":true,\"callbackUrl\":\"\"}"), "contract");
