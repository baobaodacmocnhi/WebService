                ...
                if (dtPC != null && dtPC.Rows.Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        if (result.success)
                        {
                            ...
                            _cDAL_DocSo.ExecuteNonQuery("insert into MaHoa_PhieuChuyen_LichSu(ID,DanhBo,NoiDung,GhiChu,CreateBy,CreateDate)values(" + ID + ",'" + DanhBo + "',N'" + NoiDung + "',N'" + GhiChu + "'," + MaNV + ",getdate())");
                        }
                        if (Hinh != "")
