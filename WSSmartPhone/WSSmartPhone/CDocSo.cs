...
namespace WSSmartPhone
{
    class CDocSo
    {
        ...
        public bool CapNhat(string ID, string CodeMoi, string TTDHNMoi, string CSMoi, string TieuThuMoi, string GiaBan, string PhiBVMT, string ThueGTGT,string TongCong, string ChiTiet, string Latitude, string Longitude)
        {
            string sql = "update DocSo set CSMoi=" + CSMoi + ",CodeMoi='" + CodeMoi + "',TTDHNMoi='" + TTDHNMoi + "',TieuThuMoi=" + TieuThuMoi + ",TienNuoc=" + GiaBan + ",BVMT=" + PhiBVMT + ",Thue=" + ThueGTGT + ",TongTien=" + TongCong + ","
                + "ChiTiet='" + ChiTiet + "',Latitude='" + Latitude + "',Longitude='" + Longitude + "',NgayDS=getdate() where DocSoID=" + ID + " and (NgayDS is null or Cast(NgayDS as date)=Cast(getdate() as date))";
                ...
                switch (GiaBieu)
                {
                    ...
                    case 68:///SH giá sỉ - KD giá lẻ
                        ...
                        //if (hoadon.TILESH!=null && hoadon.TILEDV!=null)
                        {
                            ...
                            //        TieuThu_DieuChinhGia = _SH - DinhMuc;
                            //}
                            GiaBan += _DV * (lstGiaNuoc[5].DonGia.Value - lstGiaNuoc[5].DonGia.Value / 100);
                            ChiTiet += "\r\n" + _DV + " x " + String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("vi-VN"), "{0:#,##}", (lstGiaNuoc[5].DonGia.Value - lstGiaNuoc[5].DonGia.Value / 100));
                            //GiaBan -= GiaBan * 10 / 100;
                        }
                        break;
